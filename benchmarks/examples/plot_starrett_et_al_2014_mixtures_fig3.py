...
:cite:t:`StarrettEtAl2014`.

The open markers are independent digitizations of the solid IS-QM curves in
the published figure. The continuous curves are the September 2026 Otter
recalculation of all nine states. Their configuration, producing-source
provenance, diagnostics, and checksums are recorded in the manifest.
...
.. include:: /_static/gallery_results/plot_starrett_et_al_2014_mixtures_fig3/results.rst
...
# Serial states; each AA inherits the single-worker default.
MAX_STATE_WORKERS = 1
...
def main() -> None:
    manifest = accepted_manifest() if USE_PRECOMPUTED_DATA else None
    results = (
    ...
    references = {
        (2.94, 20): load_reference(ROOT / 'benchmarks/reference_data/starrett_et_al_2014_mixtures_fig3/fig3_gab_rho2p94gcc_T20kK.csv'),
        (2.94, 50): load_reference(ROOT / 'benchmarks/reference_data/starrett_et_al_2014_mixtures_fig3/fig3_gab_rho2p94gcc_T50kK.csv'),
        (2.94, 100): load_reference(ROOT / 'benchmarks/reference_data/starrett_et_al_2014_mixtures_fig3/fig3_gab_rho2p94gcc_T100kK.csv'),
        (5.0, 20): load_reference(ROOT / 'benchmarks/reference_data/starrett_et_al_2014_mixtures_fig3/fig3_gab_rho5p00gcc_T20kK.csv'),
        (5.0, 50): load_reference(ROOT / 'benchmarks/reference_data/starrett_et_al_2014_mixtures_fig3/fig3_gab_rho5p00gcc_T50kK.csv'),
        (5.0, 100): load_reference(ROOT / 'benchmarks/reference_data/starrett_et_al_2014_mixtures_fig3/fig3_gab_rho5p00gcc_T100kK.csv'),
        (15.0, 20): load_reference(ROOT / 'benchmarks/reference_data/starrett_et_al_2014_mixtures_fig3/fig3_gab_rho15p00gcc_T20kK.csv'),
        (15.0, 50): load_reference(ROOT / 'benchmarks/reference_data/starrett_et_al_2014_mixtures_fig3/fig3_gab_rho15p00gcc_T50kK.csv'),
        (15.0, 100): load_reference(ROOT / 'benchmarks/reference_data/starrett_et_al_2014_mixtures_fig3/fig3_gab_rho15p00gcc_T100kK.csv'),
    }
...
# sphinx_gallery_thumbnail_path = "_static/gallery_results/plot_starrett_et_al_2014_mixtures_fig3/thumbnail.png"
