...
From the root of the complete Otter checkout, using Poetry, run::
    ...
    poetry run python docs/examples/plot_carbon_lfc_sensitivity.py
...
.. include:: /_static/gallery_results/plot_carbon_lfc_sensitivity/results.rst
...
MAX_STATE_WORKERS = 1
HNC_TOL = 1.0e-5
# Audit limit from the default max(10*hnc_tol, 1e-6) transform check.
...
# sphinx_gallery_thumbnail_path = "_static/gallery_results/plot_carbon_lfc_sensitivity/thumbnail.png"
